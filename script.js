...
function wikiJS(oldWord, language, scrollTo, hasBeenUppercase) {
    $('.results').append(`<div class="individualResult" id="` + oldWord + `"><h2><a href="javascript:delWord('` + oldWord + `')" class="deleteWord"><i class="material-icons deleteIcon">highlight_off</i></a>` + oldWord + `</h2>
